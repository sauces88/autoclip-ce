...
- **Swagger UI**: [http://localhost:8001/docs](http://localhost:8001/docs) (本地开发环境)
- **ReDoc**: [http://localhost:8001/redoc](http://localhost:8001/redoc) (本地开发环境)
...
# 手动检查服务
curl http://localhost:8001/api/v1/health/  # 后端健康检查
...
- **后端API**: [http://localhost:8001](http://localhost:8001) (本地开发环境)
- **API文档**: [http://localhost:8001/docs](http://localhost:8001/docs) (本地开发环境)
